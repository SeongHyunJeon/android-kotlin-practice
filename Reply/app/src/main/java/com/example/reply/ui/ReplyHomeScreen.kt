...
fun ReplyHomeScreen(
    ...
    val navigationItemContentList = listOf( //각각의 카테고리 정보를 포함하는 인스턴스 리스트.
    ...
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER) { //대형인 경우.
        val navigationDrawerContentDescription = stringResource(R.string.navigation_drawer)
        PermanentNavigationDrawer( //영구 탐색 레이아웃을 설정하는 컴포저블.
            drawerContent = {
                PermanentDrawerSheet(Modifier.width(dimensionResource(R.dimen.drawer_width))) {
                    NavigationDrawerContent( //영구 탐색 레이아웃의 실질적인 구현 컴포저블.
            ...
            ReplyAppContent( //영구 탐색 창을 제외한 실질적인 컨텐츠 화면 구현 컴포저블.
...
private fun ReplyAppContent(
    ...
    Row(modifier = modifier.fillMaxSize()) {
        ...
        AnimatedVisibility(visible = navigationType == ReplyNavigationType.NAVIGATION_RAIL) {//중형 화면인 경우, 레일 탐색 출력.
            ReplyNavigationRail(
        ...
        Column(
            ...
            if (contentType == ReplyContentType.LIST_AND_DETAIL) { //대형 화면에 대한 레이아웃 구성.
            ...
            AnimatedVisibility(visible = navigationType == ReplyNavigationType.BOTTOM_NAVIGATION) {//소형 화면인 경우, 하단 탐색 출력.
...
@Composable
private fun NavigationDrawerContent( //영구 탐색 컴포저블.
